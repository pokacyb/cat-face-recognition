...
import { fileUploadURL, catRecognitionURL } from "../constants";
        ...
        const config = {
            onUploadProgress: function (progressEvent) {
                const progress = Math.round(
                    (100 * progressEvent.loaded) / progressEvent.total // for upload progress bar
                );
        ...
        return (
            <Container style={{ padding: "1em" }}>
                ...
                <Segment vertical>
                    ...
                    <p>
                        POST to {catRecognitionURL} with headers: "Authentication":
                        "Token {"<your_token>"}"
                    </p>
                </Segment>
                <Segment vertical>
                    <Divider horizontal>JSON Response</Divider>
                    {loading && ( // while the file is being uploaded
                        <Progress
